...
{
    public class ConfigAirSensorViewModel
    {
        ...
        public ConfigAirSensorViewModel(SensorGroup sensorGroup)
        {
        ...
        private void UpdateSensorData()
        {
            ...
            Application.Current.MainPage.DisplayAlert("Success", "Air sensor updated.", "OK");
        }
    }
}
