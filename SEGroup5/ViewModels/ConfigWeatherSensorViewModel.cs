...
{
    public class ConfigWeatherSensorViewModel
    {
        ...
        public ConfigWeatherSensorViewModel(SensorGroup sensorGroup)
        {
        ...
        private void UpdateSensorData()
        {
            ...
            Application.Current.MainPage.DisplayAlert("Success", "Weather sensor updated.", "OK");
        }
    }
}
